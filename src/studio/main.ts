...
declare const __QUIET_PLACES_SOURCE__:{sourceRevision:string;sourceDirty:boolean};
const source=typeof __QUIET_PLACES_SOURCE__==='undefined'?{sourceRevision:null,sourceDirty:null}:__QUIET_PLACES_SOURCE__;
