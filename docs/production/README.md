...
後續實作以 [P0–P8 總計畫](ROADMAP.md) 為準：包含依賴、交付、完成條件與回退。文件存在不代表該階段完成。iPhone 方向見 [P8 實作計畫](P8_IPHONE_PLAN.md) 與 [單景 pilot 進度](IPHONE_PILOT.md)。

本輪成果與驗收見 [P0–P6 交付紀錄](P0_P6_ACCEPTANCE.md)；實際試片與候選採用指令見 [製作室操作](STUDIO.md)。

## 接手時的最短閱讀路徑

先讀 [偏好速查](PREFERENCES.md#下次製作先遵循2026-09-09-本輪沉澱)，再讀目標場景「目前狀態」與相關生物頁；目前摘要優先於歷史流水帳。已明確提出的可回退實驗、持續微動、風感、動作順序與順向時刻規則，視為後續製作預設，不需使用者再講一次。新的明確指示仍優先。
